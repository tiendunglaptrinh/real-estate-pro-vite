...
const ContentNewPost = () => {
  ...
  const handleClickPaymentPaypal = async () => {
    ...
    setAmountPayment(calculateTotalMoney(totalCost, discount));
    const response_data = await fetchApi(
      `/payment/create-order/${amountPayment}`,
      {
        method: "post",
        skipAuth: false,
      }
        ...
        <div className={cx("wrapper_new_post")}>
          {showPopupErr && (
            <Error
              ...
              message={error}
              onClick={() => {
                setShowPopupErr(false);
                scrollToField(idScroll);
              }}
            />
          )}
          ...
          <div className={cx("right_content", "userselectnone")}>
            {step1 && !step2 && (
              <div className={cx("box_info")}>
                ...
                <div
                  id="id_adress"
                  className={cx("info_option", "address_option")}
                >
                  ...
                  <div className={cx("option_address")}>
                    <div className={cx("address_part")}>
                      ...
                      <input
                        ...
                        value={address.rest || ""}
                        onChange={(e) =>
                          handleInputChange("rest", e.target.value)
                        }
                ...
                <div className={cx("info_option")}>
                  ...
                  <div className={cx("option_sub_title")}>
                    Loại bất động sản
                  </div>
                  <select
                    id="id_category"
                  ...
                  <div className={cx("wrapper_sub_option")}>
                    ...
                    <div className={cx("sub_info_option")}>
                      ...
                      >
                        ...
                        <option value="million_per_month">
                          Triệu đồng/tháng
                        </option>
                        <option value="million_per_m2">
                          Triệu đồng/m&sup2;
                        </option>
                      </select>
                    </div>
                            ...
                            <div className={cx("list_choosing_faci", "row")}>
                              ...
                              {chooseFaci.map((faci, index) => {
                                return (
                                  <div
                                    key={index}
                                    className={cx("item_choosing_faci")}
                                  >
              ...
              <div className={cx("box_info")}>
                ...
                <div className={cx("info_option")}>
                  ...
                  <div className={cx("wrapper_list_image")}>
                    ...
                    <div
                      className={cx("script_upload", { activate: showUpload })}
                    >
                    ...
                    <div className={cx("preview_images", "row")}>
                      {images.map((file, index) => (
                        <div
                          key={index}
                          className={cx("preview_item", "col-3")}
                        >
                          <FontAwesomeIcon
                            icon={faXmark}
                            fontSize="12px"
                    ...
                    <div className={cx("total_cost_container")}>
                      ...
                      <div className={cx("totalcost_payment")}>
                        <button
                          ...
                          onClick={handleShowPaymentProcess}
                        >
                          Thanh toán ngay
                          <FontAwesomeIcon
                            icon={faArrowRight}
            ...
            <div className={cx("payment_right")}>
              ...
              <div className={cx("payment_item_wrap", "userselectnone")}>
                ...
                <div className={cx("payment_method_wrap", "userselectnone")}>
                  <div
                    className={cx("payment_method", {
                      active: methodPayment == "wallet",
                    })}
                    onClick={() => setMethodPayment("wallet")}
                  >
                    <FontAwesomeIcon
                      icon={faWallet}
                      fontSize="18px"
                  ...
                  <div
                    className={cx("payment_method", {
                      active: methodPayment == "paypal",
                    })}
                    onClick={handleClickPaymentPaypal}
                  >
                    <FontAwesomeIcon
                      icon={faPaypal}
                      fontSize="18px"
                ...
                <div
                  className={cx("payment_content", {
                    active: methodPayment == "wallet",
                  })}
                >
                  <div className={cx("content_title")}>Số dư khả dụng</div>
                  <div className={cx("wallet_money")}>
                    {walletMoney}
                    <span style={{ marginLeft: "10px" }}>VND</span>
                  </div>
                  <div className={cx("analys_money")}>
                    <span className={cx("analys_title")}>Tình trạng</span>
                    <span className={cx("analys_status")}>
                      {validMoney ? "Có thể thanh toán" : "Số dư không đủ"}
                    </span>
                  </div>
                  <button
                    className={cx("btn_deposit", { active: !validMoney })}
                  >
                    Nạp tiền ngay
                  </button>
                  <button
                    className={cx("btn_submit_payment", {
                      disabled: !validMoney,
                    })}
                    disabled={!validMoney}
                    onClick={handlClickFinishPayment}
                  >
                    Thanh toán ngay
                  </button>
                </div>
                ...
                >
                  {orderId && (
                    <PaymentPaypal
                      orderId={orderId}
                      postId={postId}
                      packagePricingId={idChooseSubPackage}
                      startDate={datePicker || new Date().toISOString()}
                      money={amountPayment}
                    />
                  )}
                ...
                >
                  <p className={cx("credit_title")}>
                    Hiện tại chưa hỗ trợ phương thức thanh toán này.
                  </p>
                </div>
              </div>
            </div>
